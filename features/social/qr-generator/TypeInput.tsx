      ...
      <div className="ti-root">
        {type === "url" && (
          <div className="ti-field">
            <label className="ti-label" htmlFor="ti-url">
              Website URL
            </label>
            <input
              id="ti-url"
        ...
        {type === "text" && (
          <div className="ti-field">
            <label className="ti-label" htmlFor="ti-text">
              Plain text
            </label>
            <textarea
              id="ti-text"
        ...
        {type === "email" && (
          <>
            <div className="ti-field">
              <label className="ti-label" htmlFor="ti-email-addr">
                Email address
              </label>
              <input
                id="ti-email-addr"
            ...
            <div className="ti-field">
              <label className="ti-label" htmlFor="ti-email-sub">
                Subject <span className="ti-optional">optional</span>
              </label>
              <input
                id="ti-email-sub"
                type="text"
            ...
            <div className="ti-field">
              <label className="ti-label" htmlFor="ti-email-body">
                Message <span className="ti-optional">optional</span>
              </label>
              <textarea
                id="ti-email-body"
                className="ti-textarea"
        ...
        {type === "phone" && (
          <div className="ti-field">
            <label className="ti-label" htmlFor="ti-phone">
              Phone number
            </label>
            <input
              id="ti-phone"
        ...
        {type === "wifi" && (
          <>
            <div className="ti-field">
              <label className="ti-label" htmlFor="ti-ssid">
                Network name (SSID)
              </label>
              <input
                id="ti-ssid"
            ...
            <div className="ti-row">
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-enc">
                  Security type
                </label>
                <select
                  id="ti-enc"
            ...
            {wifi.encryption !== "nopass" && (
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-pass">
                  Password
                </label>
                <input
                  id="ti-pass"
        ...
        {type === "vcard" && (
          <>
            <div className="ti-row">
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-fn">
                  First name
                </label>
                <input
                  id="ti-fn"
              ...
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-ln">
                  Last name
                </label>
                <input
                  id="ti-ln"
            ...
            <div className="ti-row">
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-vc-phone">
                  Phone
                </label>
                <input
                  id="ti-vc-phone"
              ...
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-vc-email">
                  Email
                </label>
                <input
                  id="ti-vc-email"
            ...
            <div className="ti-row">
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-company">
                  Company <span className="ti-optional">optional</span>
                </label>
                <input
                  id="ti-company"
                  type="text"
              ...
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-title">
                  Job title <span className="ti-optional">optional</span>
                </label>
                <input
                  id="ti-title"
                  type="text"
            ...
            <div className="ti-field">
              <label className="ti-label" htmlFor="ti-vc-web">
                Website <span className="ti-optional">optional</span>
              </label>
              <input
                id="ti-vc-web"
                type="url"
        ...
        {type === "sms" && (
          <>
            <div className="ti-field">
              <label className="ti-label" htmlFor="ti-sms-phone">
                Phone number
              </label>
              <input
                id="ti-sms-phone"
            ...
            <div className="ti-field">
              <label className="ti-label" htmlFor="ti-sms-msg">
                Message <span className="ti-optional">optional</span>
              </label>
              <textarea
                id="ti-sms-msg"
        ...
        {type === "location" && (
          <>
            <div className="ti-row">
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-lat">
                  Latitude
                </label>
                <input
                  id="ti-lat"
              ...
              <div className="ti-field">
                <label className="ti-label" htmlFor="ti-lng">
                  Longitude
                </label>
                <input
                  id="ti-lng"
            ...
            <div className="ti-field">
              <label className="ti-label" htmlFor="ti-loc-label">
                Label <span className="ti-optional">optional</span>
              </label>
              <input
                id="ti-loc-label"
                type="text"
