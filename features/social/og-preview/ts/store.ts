// features/social/og-preview/ts/store.ts
...
export function useOgPreviewStore() {
  ...
  const [activeTab, setActiveTab] = useState<
    "input" | "validation" | "code" | "templates" | "history"
  >("input");
  ...
  const [historyRaw, setHistoryRaw] = useLocalStorage<HistoryStorage>("og-preview-history", {
    v: 1,
    data: [],
  });
