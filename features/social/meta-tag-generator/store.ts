// features/social/meta-tag-generator/store.ts
...
export interface MetaTagGeneratorStore {
    ...
    activeTab: "basic" | "social" | "advanced" | "preview" | "validation" | "code" | "templates" | "history";
    setActiveTab: (tab: "basic" | "social" | "advanced" | "preview" | "validation" | "code" | "templates" | "history") => void;
...
export function useMetaTagGeneratorStore() {
    ...
    const [activeTab, setActiveTab] = useState<"basic" | "social" | "advanced" | "preview" | "validation" | "code" | "templates" | "history">("basic");
