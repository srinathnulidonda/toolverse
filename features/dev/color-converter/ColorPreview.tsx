                            ...
                            <div className="cp-contrast-grid">
                                ...
                                <div className="cp-contrast-card">
                                    ...
                                    <div className="cp-contrast-info">
                                        ...
                                        <div className="cp-wcag-badges">
                                            <span
                                                className={`cp-wcag-badge${wcagWhite.AA_normal ? " pass" : " fail"
                                                    }`}
                                            >
                                                AA
                                            </span>
                                            <span
                                                className={`cp-wcag-badge${wcagWhite.AAA_normal ? " pass" : " fail"
                                                    }`}
                                            >
                                                AAA
                                            </span>
                                ...
                                <div className="cp-contrast-card">
                                    ...
                                    <div className="cp-contrast-info">
                                        ...
                                        <div className="cp-wcag-badges">
                                            <span
                                                className={`cp-wcag-badge${wcagBlack.AA_normal ? " pass" : " fail"
                                                    }`}
                                            >
                                                AA
                                            </span>
                                            <span
                                                className={`cp-wcag-badge${wcagBlack.AAA_normal ? " pass" : " fail"
                                                    }`}
                                            >
                                                AAA
                                            </span>
