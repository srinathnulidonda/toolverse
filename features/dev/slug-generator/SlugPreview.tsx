            ...
            <div className="sp-root">
                ...
                <div className="sp-mobile-tabs">
                    ...
                    >
                        ...
                        {input && (
                            <span className="sp-tab-count">{input.length}</span>
                        )}
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        ...
                        {analysis && (
                            <span className={`sp-tab-score ${analysis.readability}`}>
                                {analysis.score}
                            </span>
                        )}
                    </button>
                ...
                <div className="sp-panels">
                    {/* Input Panel */}
                    <div className={`sp-panel sp-panel-input${mobileView === "input" ? " mobile-visible" : " mobile-hidden"}`}>
                    ...
                    {/* Output Panel */}
                    <div className={`sp-panel sp-panel-output${mobileView === "output" ? " mobile-visible" : " mobile-hidden"}`}>
                        <div className="sp-panel-header">
                            <div className="sp-panel-label">
                                <i className="ti ti-sparkles" />
                            ...
                            <div className="sp-panel-meta">
                                {output && (
                                    <>
                                        ...
                                        {reductionPercent > 0 && (
                                            <span className="sp-reduction-pill sp-meta-mobile-hide">-{reductionPercent}%</span>
                                        )}
                                    </>
                                )}
                            </div>
                                                ...
                                                <div className="sp-score-container">
                                                    ...
                                                    <div className="sp-score-info">
                                                        ...
                                                        <div className={`sp-score-badge ${analysis.readability}`}>
                                                            {analysis.readability.charAt(0).toUpperCase() + analysis.readability.slice(1)}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    {analysis.seoIssues.length > 0 && (
                                                        <div className="sp-issues">
                                                            ...
                                                            {analysis.seoIssues.map((issue, i) => (
                                                                <div key={i} className="sp-issue-item">• {issue}</div>
                                                            ))}
                                                        </div>
                                                    )}
                                                    {analysis.suggestions.length > 0 && (
                                                        <div className="sp-suggestions">
                                                            ...
                                                            {analysis.suggestions.map((suggestion, i) => (
                                                                <div key={i} className="sp-suggestion-item">• {suggestion}</div>
                                                            ))}
                                                        </div>
                                                    )}
                                                </div>
