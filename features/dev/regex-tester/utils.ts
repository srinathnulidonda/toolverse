// features/dev/regex-tester/utils.ts
...
export const FLAG_DEFINITIONS = [
    ...
    { id: "i" as Flag, label: "Case Insensitive", desc: "Ignore case sensitivity", icon: "ti-letter-case" },
    { id: "m" as Flag, label: "Multiline", desc: "^ and $ match line breaks", icon: "ti-line-height" },
