...
export default function RegexLibrary({
    ...
    const [selectedCategory, setSelectedCategory] = useState<PatternCategory | "all" | "favorites">("all");
    const [view, setView] = useState<"grid" | "list">("grid");
    const [showImportDialog, setShowImportDialog] = useState(false);
    const [importText, setImportText] = useState("");

    const categories: Array<{ id: PatternCategory | "all" | "favorites"; label: string; icon: string }> = [
                ...
                <div className="rxl-categories">
                    {categories.map((cat) => (
                        ...
                        >
                            ...
                            <span>{cat.label}</span>
                            {cat.id === "all" && (
                                <span className="rxl-category-count">{allPatterns.length}</span>
                            )}
                    ...
                    <div className="rxl-dialog-overlay" onClick={() => setShowImportDialog(false)}>
                        <div className="rxl-dialog" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="rxl-dialog-body">
                                <p className="rxl-dialog-desc">
                                    Paste your exported JSON patterns below:
                                </p>
                                <textarea
