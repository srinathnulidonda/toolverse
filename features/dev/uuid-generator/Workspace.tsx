...
export default function UuidGeneratorWorkspace({ tool }: { tool: Tool }) {
    ...
    const { history, addToHistory, clearHistory, removeFromHistory } = useUuidStore();

    const handleSingleGenerated = useCallback((uuid: string) => {
        addToHistory({
            uuids: [uuid],
            version,
            format,
    ...
    const handleBatchComplete = useCallback((uuids: string[]) => {
        addToHistory({
            uuids,
            version,
            format,
    ...
    const handleRestoreFromHistory = useCallback((entry: typeof history[0]) => {
            ...
            <div className="ug-workspace-root">
                ...
                <div className="ug-footer">
                    <div className="ug-footer-info">
                        ...
                        <span>
                            UUIDs are generated using cryptographically secure random numbers. 
