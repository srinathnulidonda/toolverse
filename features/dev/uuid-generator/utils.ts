// features/dev/uuid-generator/utils.ts
...
/*  Version metadata  */
export const VERSION_INFO: Record<UuidVersion, { 
    label: string; 
    desc: string; 
    useCase: string;
    sortable: boolean;
...
export function generateV7(): string {
    ...
    const rand62 = Array.from({ length: 15 }, () => 
...
export function formatUuid(uuid: string, format: UuidFormat, uuidCase: UuidCase = "lowercase"): string {
...
function parseV1orV6(uuid: string, version: 1 | 6): { 
    timestamp: number; 
    clockSequence: number; 
    node: string;
} {
