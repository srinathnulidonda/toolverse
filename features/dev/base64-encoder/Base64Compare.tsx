        ...
        <>
                                ...
                                <div className="bc-detail-grid">
                                    ...
                                    <div className="bc-detail-card">
                                        ...
                                        <div className="bc-detail-value">
                                            {comparison.sizeDiff > 0 ? "+" : ""}{formatBytes(Math.abs(comparison.sizeDiff))}
                                        </div>
                                        <div className="bc-detail-label">
                                            {comparison.sizeDiff > 0 ? "Right is larger" : comparison.sizeDiff < 0 ? "Left is larger" : "Same size"}
                                        </div>
                                    </div>
            ...
            <style jsx>{`
                ...
                .bc-mode-btn {
                    ...
                    padding: 0 12px;
                    border: none;
                    border-radius: calc(var(--b64-radius-md) - 2px);
                ...
                .bc-result-card.identical {
                    background: var(--brand-light);
                    border-color: var(--brand-border);
                }

                .bc-result-card.different {
                    background: #EFF6FF;
                    border-color: #BFDBFE;
                }
                ...
                .bc-result-card.identical .bc-result-icon {
                    background: var(--brand);
                    color: white;
                }

                .bc-result-card.different .bc-result-icon {
                    background: #DBEAFE;
                    color: #1D4ED8;
                }
                ...
                .bc-result-card.identical .bc-result-title {
                    color: var(--brand-text);
                }

                .bc-result-card.different .bc-result-title {
                    color: #1D4ED8;
                }
                ...
                .bc-result-card.identical .bc-result-desc {
                    color: var(--brand-text);
                    opacity: 0.8;
                }

                .bc-result-card.different .bc-result-desc {
                    color: #1D4ED8;
                    opacity: 0.8;
                }
