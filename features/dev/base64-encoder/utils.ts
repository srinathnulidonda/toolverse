...
function encodeFile(file: File, options: EncodingOptions): string {
...
export function decodeBase64(str: string, options: EncodingOptions): { text: string; error?: string; bytes?: Uint8Array } {
    try {
        let data = str;
