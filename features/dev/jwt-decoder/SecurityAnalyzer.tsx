    ...
    const issues = useMemo((): SecurityIssue[] => {
        ...
        if (alg === 'NONE') {
            ...
            findings.push({
                ...
                description: 'HS256 uses a shared secret. If the secret is compromised, anyone can create valid tokens',
        ...
        if (payloadStr.includes('password') || payloadStr.includes('secret') || payloadStr.includes('private')) {
            findings.push({
                severity: 'critical',
    ...
    return (
        <>
            ...
            <style jsx>{`
                ...
                .sa-score-grade--a { background: linear-gradient(135deg, #10B981 0%, #059669 100%); }
                .sa-score-grade--b { background: linear-gradient(135deg, #3B82F6 0%, #2563EB 100%); }
                .sa-score-grade--c { background: linear-gradient(135deg, #F59E0B 0%, #D97706 100%); }
                .sa-score-grade--d { background: linear-gradient(135deg, #F97316 0%, #EA580C 100%); }
                .sa-score-grade--f { background: linear-gradient(135deg, #EF4444 0%, #DC2626 100%); }
                ...
                @media (prefers-color-scheme: dark) {
                    .sa-summary-item--critical { color: #F87171; }
                    .sa-summary-item--warning { color: #FBBF24; }
                    .sa-summary-item--info { color: #60A5FA; }
                    .sa-summary-item--success { color: #34D399; }
                }
                ...
                @media (prefers-color-scheme: dark) {
                    .sa-issue--critical { border-left-color: #F87171; background: rgba(248, 113, 113, 0.05); }
                    .sa-issue--warning { border-left-color: #FBBF24; background: rgba(251, 191, 36, 0.05); }
                    .sa-issue--info { border-left-color: #60A5FA; background: rgba(96, 165, 250, 0.05); }
                }
                ...
                .sa-issue--critical .sa-issue-icon { color: #DC2626; }
                .sa-issue--warning .sa-issue-icon { color: #D97706; }
                .sa-issue--info .sa-issue-icon { color: #2563EB; }
                
                @media (prefers-color-scheme: dark) {
                    .sa-issue--critical .sa-issue-icon { color: #F87171; }
                    .sa-issue--warning .sa-issue-icon { color: #FBBF24; }
                    .sa-issue--info .sa-issue-icon { color: #60A5FA; }
                }
                ...
                @media (prefers-color-scheme: dark) {
                    .sa-issue-badge--critical { background: #F87171; color: #1A1A17; }
                    .sa-issue-badge--warning { background: #FBBF24; color: #1A1A17; }
                    .sa-issue-badge--info { background: #60A5FA; color: #1A1A17; }
                }
