        ...
        <>
            <div className="up-root">
                ...
                <div className="up-panels">
                    {/* Input Panel */}
                    <div className={`up-panel${mobileView === "input" ? " mobile-visible" : " mobile-hidden"}`}>
                        <div className="up-panel-header">
                            ...
                            <div className="up-panel-meta">
                                {input && (
                                    <span className="up-meta-size">{formatBytes(inputBytes)}</span>
                                )}
                            </div>
                        </div>
                    ...
                    {/* Output Panel */}
                    <div className={`up-panel${mobileView === "output" ? " mobile-visible" : " mobile-hidden"}`}>
                        <div className="up-panel-header">
                            <div className="up-panel-label">
