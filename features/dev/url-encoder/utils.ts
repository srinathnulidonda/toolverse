...
export const SAMPLE_URLS = {
    ...
    api: {
        ...
        encoded: "https%3A%2F%2Fapi.example.com%2Fv1%2Fusers%3Ffilter%3Dname%3AJo%C3%A3o%20%26%20role%3Dadmin"
    },
    redirect: {
        plain: "https://auth.example.com/login?redirect=https://app.example.com/dashboard?tab=analytics",
        encoded: "https%3A%2F%2Fauth.example.com%2Flogin%3Fredirect%3Dhttps%3A%2F%2Fapp.example.com%2Fdashboard%3Ftab%3Danalytics"
    },
    social: {
        plain: "https://twitter.com/share?text=Check this out! 🚀&url=https://example.com",
        encoded: "https%3A%2F%2Ftwitter.com%2Fshare%3Ftext%3DCheck%20this%20out!%20%F0%9F%9A%80%26url%3Dhttps%3A%2F%2Fexample.com"
    }
};
...
export function decodeUrl(str: string, options?: EncodingOptions): { result: string; error?: string } {
    try {
...
export function validateUrl(str: string): ValidationResult {
    ...
    try {
        ...
        issues.push({ type: "error", message: "Invalid URL structure" });
    }
...
export function analyzeUrl(input: string, output: string, mode: Mode): {
    inputBytes: number;
    outputBytes: number;
    percentCount: number;
    ratio: number;
