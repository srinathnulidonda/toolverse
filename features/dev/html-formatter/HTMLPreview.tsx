        ...
        <>
            <div className="hp-root">
                ...
                <div className="hp-toolbar">
                    ...
                    <div className="hp-mode-group">
                        {(Object.entries(VIEWPORT_CONFIG) as [PreviewMode, typeof VIEWPORT_CONFIG[PreviewMode]][]).map(
                            ([mode, cfg]) => (
                                <button
                                    key={mode}
                                    type="button"
                ...
                <div className="hp-canvas">
                    ...
                    <div
                        className="hp-shell"
                        style={{ maxWidth: VIEWPORT_CONFIG[previewMode].width }}
                    >
                        {/* Browser chrome */}
            ...
            <style jsx>{`
                ...
                @media (prefers-reduced-motion: reduce) {
                    .hp-shell { transition: none; }
                    .hp-spinner i { animation: none; }
                }
            `}</style>
        </>
    );
