  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .hf-setting-checkbox input {
          cursor: pointer;
        }
        .hf-setting-checkbox span {
          font-size: 12px;
          color: var(--text-secondary);
        }
        ...
        .hf-panel-btn:hover:not(:disabled) {
          background: var(--bg-surface);
          color: var(--text);
        }
        .hf-panel-btn:disabled {
          opacity: 0.4;
          cursor: not-allowed;
        }
        ...
        .hf-view-result-btn:hover {
          background: var(--brand-hover);
        }
        .hf-view-result-btn i {
          font-size: 16px;
        }
        ...
        .hf-stat-value.success {
          color: #16a34a;
        }
        .hf-stat-value.warning {
          color: #d97706;
        }
        ...
        .hf-mobile-action-btn:hover {
          background: var(--bg-surface);
          color: var(--text);
        }
        .hf-mobile-action-btn.copied {
          background: var(--brand-light);
          color: var(--brand-text);
          border-color: var(--brand-border);
        }
        .hf-mobile-action-btn i {
          font-size: 16px;
        }
        ...
        .hf-history-item:hover {
          border-color: var(--brand-border);
          box-shadow: 0 2px 8px rgba(0, 0, 0, 0.04);
        }

        .hf-history-item-header {
          display: flex;
          align-items: center;
          justify-content: space-between;
          gap: 12px;
        ...
        .hf-history-item-time {
          font-size: 11px;
          color: var(--text-tertiary);
          font-family: var(--font-mono);
        }

        .hf-history-item-meta {
          display: flex;
          align-items: center;
          gap: 8px;
          flex-shrink: 0;
        ...
        .hf-history-savings.positive {
          color: #16a34a;
        }
        .hf-history-savings.negative {
          color: #d97706;
        }
