...
export default function JSMinifierWorkspace({ tool }: { tool: Tool }) {
    ...
    const result = useMemo(() => {
        ...
        try { return processJS(input, options); }
        catch { return null; }
    }, [input, options]);
    ...
    const TABS = [
        ...
        { id: "analysis" as const, label: "Analysis", icon: "ti-chart-bar",     desc: "Code analysis & lint"   },
    ...
    return (
        <>
                        ...
                        <div className="jw-settings-grid">
                            ...
                            <label className="jw-toggle">
                                <input
                                    ...
                                    onChange={e => setOptions(p => ({ ...p, collapseWhitespace: e.target.checked }))}
                                />
                                <div className="jw-toggle-track"><div className="jw-toggle-thumb" /></div>
                            ...
                            <label className="jw-toggle">
                                <input
                                    ...
                                    onChange={e => setOptions(p => ({ ...p, deadCodeElimination: e.target.checked }))}
                                />
                                <div className="jw-toggle-track"><div className="jw-toggle-thumb" /></div>
                                    ...
                                    <div className="jw-panel-bar">
                                        <div className="jw-panel-label">
                                            ...
                                            {options.mode === "minify"   ? "Minified" :
                                             options.mode === "compress" ? "Compressed" :
                                                                           "Mangled"} JavaScript
                                        </div>
                                        <div className="jw-panel-actions">
                                            {result && (
                                        ...
                                        <>
                                            ...
                                            <div className="jw-stats-bar">
                                                ...
                                                <div className="jw-stat">
                                                    ...
                                                    <span className="jw-stat-value">{formatBytes(result.stats.minified)}</span>
                                                </div>
                    ...
                    {tabView === "analysis" && (
                        result ? (
                            ...
                            <div className="jw-tab-empty">
                                ...
                                <h3>Code Analysis</h3>
                                <p>Add JavaScript code to see detailed analysis, code quality metrics, and linting results.</p>
                                <button type="button" className="jw-tab-empty-btn" onClick={() => setTabView("minify")}>
                                    Go to Minifier
                                </button>
                            </div>
                        )
                                            ...
                                            <div key={entry.id} className="jw-history-item">
                                                ...
                                                <div className="jw-history-item-right">
                                                    ...
                                                    <button
                                                        type="button"
                                                        className="jw-icon-btn"
                                                        onClick={() => { setInput(entry.input); setTabView("minify"); }}
                                                        title="Restore"
                                                    >
            ...
            <style jsx>{`
                ...
                @media (prefers-color-scheme: dark) {
                    .jw-stat--highlight { background: #022c22; }
                }
                ...
                @media (prefers-color-scheme: dark) {
                    .jw-history-savings { color: #4ade80; }
                }
                ...
                @media (max-width: 768px) {
                    ...
                    .jw-mode-pill { padding: 0 7px; font-size: 10px; }
                    ...
                    .jw-toolbar-left { justify-content: flex-start; overflow-x: auto; flex-wrap: nowrap; }
                ...
                @media (prefers-reduced-motion: reduce) {
                    ...
                    .jw-history-item,
                    .jw-toggle-track,
                    .jw-toggle-thumb { transition: none; }
                }
            `}</style>
        </>
    );
