        ...
        <>
            <div className="jb-root">
                    ...
                    <div className="jb-upload-area">
                        ...
                        <label htmlFor="jb-files" className="jb-drop-zone">
                            ...
                            <div>
                                ...
                                <p className="jb-drop-sub">.js · .mjs · .cjs · .ts · .jsx · .tsx · Multiple files</p>
                            </div>
                        </label>
                    </div>
                ...
                {items.length === 0 && (
                    <div className="jb-empty">
                        ...
                        <p className="jb-empty-desc">Upload multiple JavaScript files to minify them all at once with the same settings.</p>
                    </div>
                )}
            </div>
            ...
            <style jsx>{`
                ...
                @media (max-width: 768px) {
                    ...
                    .jb-summary-stats { justify-content: space-around; }

                    .jb-result-info { flex-wrap: wrap; }
                }
            `}</style>
        </>
    );
