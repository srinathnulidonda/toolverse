        ...
        <>
            <div className="tp-root">
                ...
                <div className="tp-panels">
                    {/* Input Panel */}
                    <div className={`tp-panel tp-panel-input${mobileView === "input" ? " mobile-visible" : " mobile-hidden"}`}>
                        <div className="tp-panel-header">
                            ...
                            <div className="tp-panel-meta">
                                {options.unit && (
                                    <span className="tp-unit-pill">{options.unit}</span>
                                )}
                            </div>
                        </div>
                    ...
                    {/* Output Panel */}
                    <div className={`tp-panel tp-panel-output${mobileView === "output" ? " mobile-visible" : " mobile-hidden"}`}>
                        <div className="tp-panel-header">
                            <div className="tp-panel-label">
                                <i className="ti ti-calendar" />
                            ...
                            {!result ? (
                                <div className="tp-empty">
                                    ...
                                    <p className="tp-empty-desc">
                                        Enter a timestamp on the left to see all formats
                                    </p>
                                </div>
                            ) : (
