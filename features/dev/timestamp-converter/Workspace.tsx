            ...
            <div className="tcv-root">
                ...
                <div className="tcv-chrome">
                    <div className="tcv-chrome-left">
                        <button
                            className="tcv-preset-btn tcv-preset-primary"
                            onClick={loadCurrent}
                        >
                ...
                <div className="tcv-live">
                    ...
                    <div className="tcv-live-time" suppressHydrationWarning>{currentTime !== null ? currentTime : '--'}</div>
                ...
                <div className="tcv-tab-content">
                    ...
                    {viewTab === "compare" && (
                        <TimestampCompare options={options} />
                    )}
