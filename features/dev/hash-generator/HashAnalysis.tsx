...
export default function HashAnalysis({ results, inputSize }: HashAnalysisProps) {
    const analysis = useMemo(() => {
        ...
        const strengthDistribution = results.reduce((acc, result) => {
            acc[result.strength] = (acc[result.strength] || 0) + 1;
            return acc;
        }, {} as Record<string, number>);

        const bitLengthDistribution = results.reduce((acc, result) => {
                ...
                <div className="ha-section">
                    ...
                    <div className="ha-comparison">
                        {results.map((result) => {
                            ...
                            const relativeSpeed = (analysis.fastestHash.executionTime / result.executionTime) * 100;
                            ...
                            return (
                                <div key={result.algorithm} className="ha-comparison-item">
                                    <div className="ha-comparison-header">
                                        ...
                                        <div className="ha-comparison-time">
                                    ...
                                    <div className="ha-comparison-details">
                                        ...
                                        <span className="ha-comparison-strength">{result.strength.replace('-', ' ')}</span>
                                        <span className="ha-comparison-entropy">{result.metadata.entropy}% entropy</span>
                                    </div>
                                </div>
                            );
                        })}
                            ...
                            .map(([bitLength, count]) => {
                                ...
                                return (
                                    <div key={bitLength} className="ha-distribution-item">
                                        <div className="ha-distribution-label">
                                            {bitLength} bits
                                        </div>
                                        <div className="ha-distribution-bar">
                                            <div 
                                                className="ha-distribution-fill"
                    ...
                    <div className="ha-recommendations">
                        {analysis.securityAnalysis.deprecated > 0 && (
                            <div className="ha-recommendation ha-recommendation--warning">
                                ...
                                <div>
                                    <strong>Security Warning:</strong> You're using {analysis.securityAnalysis.deprecated} deprecated algorithm{analysis.securityAnalysis.deprecated !== 1 ? 's' : ''}. Consider using SHA-256 or SHA-3 instead.
                                </div>
                            </div>
                        )}
                        ...
                        {analysis.securityAnalysis.recommended === 0 && (
                            <div className="ha-recommendation ha-recommendation--info">
                                ...
                                <div>
                                    <strong>Recommendation:</strong> For maximum security, consider using SHA-256, SHA-512, or SHA-3 algorithms.
                                </div>
                            </div>
                        )}
                        ...
                        {analysis.fastestHash.executionTime > 100 && (
                            <div className="ha-recommendation ha-recommendation--performance">
                                ...
                                <div>
                                    <strong>Performance:</strong> For better performance with large inputs, consider using BLAKE2b or BLAKE2s.
                                </div>
                            </div>
                        )}
                        ...
                        {inputSize > 1024 * 1024 && (
                            <div className="ha-recommendation ha-recommendation--info">
                                ...
                                <div>
                                    <strong>Large File:</strong> For files over 1MB, consider streaming hash computation for better memory usage.
                                </div>
                            </div>
                        )}
                    </div>
