...
export default function ValidationPanel({ result }: ValidationPanelProps) {
    const summary = useMemo(() => {
        const totalIssues = result.errors.length + result.warnings.length + result.securityIssues.length;
    ...
    const [activeTab, setActiveTab] = useState<'stats' | 'metadata' | 'issues' | 'suggestions'>('stats');
                            ...
                            <div className="vp-section">
                                ...
                                <div className="vp-issues">
                                    {result.errors.map((error, idx) => (
                                        <div key={idx} className={`vp-issue vp-issue--error vp-issue--${error.severity}`}>
                            ...
                            <div className="vp-section">
                                ...
                                <div className="vp-issues">
                                    {result.securityIssues.map((issue, idx) => (
                                        <div key={idx} className={`vp-issue vp-issue--security vp-issue--${issue.severity}`}>
                                            <div className="vp-issue-icon">
                            ...
                            <div className="vp-section">
                                ...
                                <div className="vp-issues">
                                    {result.warnings.map((warning, idx) => (
                                        <div key={idx} className={`vp-issue vp-issue--warning vp-issue--${warning.severity}`}>
                                            <div className="vp-issue-icon">
                                                <i className="ti ti-alert-triangle" />
                                            </div>
                                            <div className="vp-issue-content">
            ...
            <div className="vp-root">
                ...
                <div className="vp-summary">
                    <div className="vp-summary-card">
                        <div className="vp-summary-icon" style={{
