...
import { generateSchemaFromJSON, validateJSON, type JSONSchema, type ValidationOptions } from "./validatorEngine";
                        ...
                        <div className="sv-generated">
                            <div className="sv-generated-header">
                                ...
                                <button
                                    ...
                                    onClick={useGeneratedSchema}
                                >
                                    <i className="ti ti-arrow-up" />
                                    Use This Schema
                                </button>
                            </div>
                            <pre className="sv-schema-preview">
                    ...
                    {schemaValidationResult && (
                        <div className="sv-results">
                            {'error' in schemaValidationResult ? (
                                ...
                                <div className={`sv-result sv-result--${schemaValidationResult.valid ? "valid" : "invalid"}`}>
                                    <div className="sv-result-icon">
                                        <i className={`ti ${schemaValidationResult.valid ? "ti-circle-check" : "ti-alert-circle"}`} />
                                    </div>
                                    <div className="sv-result-content">
                                        ...
                                        {!schemaValidationResult.valid && schemaValidationResult.errors.length > 0 && (
                                            <div className="sv-schema-errors">
                                                {schemaValidationResult.errors.filter(e => e.type === "schema").map((error, idx) => (
                    ...
                    {!generatedSchema && !schemaInput && (
                        <div className="sv-empty">
                            ...
                            <p className="sv-empty-desc">
                                Validate your JSON data against a JSON Schema. Load a sample schema or generate one from your JSON.
                            </p>
                        </div>
                    )}
                </div>
