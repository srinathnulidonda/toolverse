// features/dev/diff-checker/diffEngine.ts
export type DiffAlgorithm = "myers" | "word" | "character";
export type DiffViewMode = "split" | "unified" | "inline";
export type FileType = "text" | "javascript" | "typescript" | "css" | "html" | "json" | "markdown" | "xml";
...
function computeWordDiff(lines1: string[], lines2: string[], originalText1: string, originalText2: string): DiffResult {
    ...
    return {
        ...
        stats: {
            ...
            similarity: Math.round(((words1.length + words2.length - added - removed) / Math.max(words1.length, words2.length)) * 100),
            linesOfContext: 0,
        },
