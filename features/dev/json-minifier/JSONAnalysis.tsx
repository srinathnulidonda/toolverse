  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .jva-feature.on i:first-child {
          color: var(--brand);
        }
        .jva-feature.off i:first-child {
          color: var(--text-disabled);
        }
        ...
        .jva-feature.on .jva-feature-tick {
          color: #22c55e !important;
        }
        .jva-feature.off .jva-feature-tick {
        ...
        .jva-schema-type--string {
          background: #eff6ff;
          color: #2563eb;
        }
        .jva-schema-type--number {
          background: #faf5ff;
          color: #7c3aed;
        }
        .jva-schema-type--boolean {
          background: #fff7ed;
          color: #ea580c;
        }
        .jva-schema-type--null {
          background: var(--bg-surface);
          color: var(--text-tertiary);
        }
        .jva-schema-type--object {
          background: #fef2f2;
          color: #dc2626;
        }
        .jva-schema-type--array {
          background: #f0fdf4;
          color: #16a34a;
        }
        ...
        .jva-issue--error .jva-issue-icon {
          background: #fef2f2;
          color: #dc2626;
        }
        .jva-issue--warning .jva-issue-icon {
          background: #fef3c7;
          color: #d97706;
        }
        .jva-issue--info .jva-issue-icon {
          background: #eff6ff;
          color: #2563eb;
        }
