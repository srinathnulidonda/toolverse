// features/dev/css-minifier/CSSHistory.tsx
"use client";

import type { HistoryEntry } from "./cssStore";
import { formatBytes } from "@/utils";

interface CSSHistoryProps {
    history: HistoryEntry[];
    onClear: () => void;
    onRestore: (entry: HistoryEntry) => void;
}

export default function CSSHistory({ history, onClear, onRestore }: CSSHistoryProps) {
                ...
                {history.length === 0 ? (
                    <div className="ch-empty">
                        ...
                        <p className="ch-empty-desc">
                            Your minification history will appear here. History is stored locally in your
                            browser.
                        </p>
                    </div>
                ) : (
                                        ...
                                        <div className="ch-item-info">
                                            ...
                                            {entry.stats && (
                                                <span className="ch-item-savings">
                                                    Saved {formatBytes(entry.stats.savings)} (
                                                    {entry.stats.savingsPercent}%)
                                                </span>
                                            )}
                                        </div>
                                        <button
                                            ...
                                            title="Restore this minification"
                                        >
