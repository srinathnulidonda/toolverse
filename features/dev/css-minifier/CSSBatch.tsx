                                        ...
                                        <div className="cb-result-info">
                                            ...
                                            {item.stats && (
                                                <span className="cb-result-stats">
                                                    {formatBytes(item.stats.original)} →{" "}
                                                    {formatBytes(item.stats.minified)} (
                ...
                {items.length === 0 && (
                    <div className="cb-empty">
                        ...
                        <p className="cb-empty-desc">
                            Upload multiple CSS files and minify them all at once. Results can be
                            downloaded individually or as a batch.
                        </p>
                    </div>
                )}
            </div>
