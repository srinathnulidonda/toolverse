        ...
        <div className="ga-section">
          ...
          <div className="ga-breakdown">
            {breakdown.map((item, idx) => {
              const barWidth =
                calculation.finalAmount > 0 && isFinite(calculation.finalAmount)
            ...
            <div className="ga-comparison-table">
              {comparison.map((item) => (
                ...
                >
                  ...
                  {item.isCurrent && <div className="ga-comparison-diff">—</div>}
                  {!item.isCurrent && (
                    <div
                      className={`ga-comparison-diff ${item.total < calculation.finalAmount ? "positive" : "negative"}`}
                    >
          ...
          <div className="ga-insights">
            <div className="ga-insight ga-insight--info">
              ...
              <div className="ga-insight-content">
                <div className="ga-insight-title">
                  Tax Type: {options.gstType === "intra" ? "Intra-State" : "Inter-State"}
                </div>
            ...
            {insights.isHighTax && (
              <div className="ga-insight ga-insight--warning">
                ...
                <div className="ga-insight-content">
                  ...
                  <div className="ga-insight-text">
                    This item falls under {options.gstRate}% GST slab, typically for luxury goods or
                    non-essential items. Consider if input tax credit (ITC) is available to offset
                    this cost.
                  </div>
                </div>
              </div>
            ...
            {insights.hasCess && (
              <div className="ga-insight ga-insight--info">
                ...
                <div className="ga-insight-content">
                  ...
                  <div className="ga-insight-text">
                    Cess of {options.cessRate}% is charged over and above GST. Common for tobacco,
                    luxury cars, and aerated drinks. Cess goes to compensation fund.
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="ga-insight ga-insight--tip">
              ...
              <div className="ga-insight-content">
                ...
                <div className="ga-insight-text">
                  If you're a registered taxpayer, you can claim input tax credit (ITC) of{" "}
                  {formatCurrency(calculation.gstAmount)} on this purchase, subject to eligibility
                  rules.
                </div>
              </div>
            </div>
