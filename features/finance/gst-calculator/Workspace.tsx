...
export default function GSTCalculatorWorkspace() {
    ...
    const handleRateChange = useCallback((field: 'gstRate' | 'cessRate' | 'discountPercent', value: string) => {
        const parsed = parseFloat(value);
        if (isNaN(parsed)) {
                        ...
                        <div className="gw-mode-pills">
                            {(["exclusive", "inclusive", "reverse"] as GSTMode[]).map(m => (
                                <button
                                    ...
                                    title={
                                        m === "exclusive" ? "Add GST to amount" :
                                        m === "inclusive" ? "Extract GST from amount" :
                            ...
                            <div className="gw-settings-grid">
                                ...
                                <div className="gw-form-group">
                                    ...
                                    <select
                                        ...
                                        onChange={e => handleOptionsChange({ roundingMode: e.target.value as RoundingMode })}
                                    >
                                ...
                                <div className="gw-form-group">
                                    <label className="gw-toggle">
                                        ...
                                        />
                                        <div className="gw-toggle-track"><div className="gw-toggle-thumb" /></div>
                    ...
                    <div className="gw-hsn-search">
                        <div className="gw-hsn-search-header">
                            ...
                            <button
                                ...
                                onClick={() => setShowHSNSearch(false)}
                            >
                                <i className="ti ti-x" />
                            </button>
                        </div>
                    ...
                    <div className={`gw-panel ${mobilePanel === "input" ? "mob-visible" : "mob-hidden"}`}>
                        ...
                        <div className="gw-input-section">
                            ...
                            {(options.quantity > 1 || options.pricePerUnit > 0) && (
                                <div className="gw-calc-mode-indicator">
                                    ...
                                    Using {options.quantity} × ₹{options.pricePerUnit.toLocaleString('en-IN')} = ₹{(options.quantity * options.pricePerUnit).toLocaleString('en-IN')}
                                </div>
                            )}
                            ...
                            <div className="gw-qty-price">
                                ...
                                <div className="gw-form-group">
                                    ...
                                    <input
                                        ...
                                        onChange={e => handleOptionsChange({ pricePerUnit: parseFloat(e.target.value) || 0 })}
                                        min="0"
                                        step="0.01"
                            ...
                            <div className="gw-mode-help">
                                ...
                                <div>
                                    {options.mode === "exclusive" && (
                                        <>
                                            <strong>GST Exclusive:</strong> Enter the base amount. GST will be added on top.
                                        </>
                                    )}
                                    {options.mode === "inclusive" && (
                                        <>
                                            <strong>GST Inclusive:</strong> Enter the total amount. GST will be extracted from it.
                                        </>
                                    )}
                                    {options.mode === "reverse" && (
                                        <>
                                            <strong>Reverse Calculation:</strong> Enter the final total. Original amount and GST will be calculated.
                                        </>
                                    )}
                                </div>
                            </div>
                        ...
                        {amount && calculation && (
                            <div className="gw-mob-cta">
                                <button type="button" className="gw-cta-btn" onClick={() => setMobilePanel("output")}>
                                    <i className="ti ti-report-money" />
                                    View GST Breakdown
                        ...
                        {!calculation && (
                            <div className="gw-empty">
                                ...
                                <p className="gw-empty-desc">
                                    Enter an amount on the left to calculate GST automatically. Support for exclusive, inclusive, and reverse calculations.
                                </p>
                            </div>
                        )}
