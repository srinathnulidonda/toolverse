...
export default function ITCAnalysis({ calculation, options, purchaseAmount }: ITCAnalysisProps) {
  const insights = useMemo(() => {
    ...
    const blockedPercentage =
      calculation.blockedITC > 0 ? (calculation.blockedITC / calculation.totalITC) * 100 : 0;
    const utilizationRate =
      calculation.eligibleITC > 0 ? (calculation.itcUtilized / calculation.eligibleITC) * 100 : 0;
    const cashflowImpact = calculation.itcBalance;
    const monthlySavings =
      options.period === "annual"
        ? calculation.itcBalance / 12
        : options.period === "quarterly"
          ? calculation.itcBalance / 3
  ...
  const monthlyProjection = useMemo(() => {
    ...
    const monthlyITC =
      options.period === "annual" ? calculation.eligibleITC / 12 : calculation.eligibleITC / 3;
    const monthlyBalance =
      options.period === "annual" ? calculation.itcBalance / 12 : calculation.itcBalance / 3;
          ...
          <div className="ia-flow">
            ...
            <div className="ia-flow-step">
              ...
              <div className="ia-flow-content">
                ...
                <div className="ia-flow-value ia-flow-value--add">
              ...
              <>
                ...
                <div className="ia-flow-step">
                  ...
                  <div className="ia-flow-content">
                    ...
                    <div className="ia-flow-value ia-flow-value--sub">
            ...
            <div className="ia-flow-step ia-flow-step--highlight">
              ...
              <div className="ia-flow-content">
                ...
                <div className="ia-flow-value ia-flow-value--final">
            ...
            {calculation.itcUtilized > 0 && (
              <>
                ...
                <div className="ia-flow-step">
                  <div className="ia-flow-number">
                    {(calculation.blockedITC > 0 ? 1 : 0) +
                      (calculation.reversedITC > 0 ? 1 : 0) +
                      4}
                  </div>
                  <div className="ia-flow-content">
                ...
                <div className="ia-flow-step ia-flow-step--final">
                  ...
                  <div className="ia-flow-content">
                    ...
                    <div className="ia-flow-value ia-flow-value--balance">
            ...
            <div className="ia-projection">
              <div className="ia-projection-card">
                ...
                <div className="ia-projection-content">
                  ...
                  <div className="ia-projection-value">
                    {formatCurrency(monthlyProjection.purchase)}
                  </div>
                </div>
              </div>
              <div className="ia-projection-card">
              ...
              <div className="ia-projection-card">
                ...
                <div className="ia-projection-content">
                  ...
                  <div className="ia-projection-value">
                    {formatCurrency(monthlyProjection.balance)}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="ia-insights">
            ...
            {insights.isHighBlocked && (
              <div className="ia-insight ia-insight--warning">
                ...
                <div className="ia-insight-content">
                  ...
                  <div className="ia-insight-text">
                    {insights.blockedPercentage}% of your GST cannot be claimed as ITC. Consider
                    reviewing your purchase patterns to minimize blocked credits (motor vehicles,
            ...
            {insights.isLowUtilization && (
              <div className="ia-insight ia-insight--tip">
                ...
                <div className="ia-insight-content">
                  ...
                  <div className="ia-insight-text">
                    You've only utilized {insights.utilizationRate}% of eligible ITC. Consider using
                    remaining credits before they expire or become time-barred.
                  </div>
                </div>
              </div>
            )}
            ...
            {insights.hasAvailableCredit && (
              <div className="ia-insight ia-insight--success">
                ...
                <div className="ia-insight-content">
                  ...
                  <div className="ia-insight-text">
                    You have {formatCurrency(calculation.itcBalance)} in available ITC. This can
                    offset your next GST payment, improving cash flow by{" "}
                    {formatCurrency(insights.monthlySavings)}{" "}
                    {options.period === "monthly" ? "monthly" : "per month"}.
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="ia-insight ia-insight--compliance">
              ...
              <div className="ia-insight-content">
                ...
                <div className="ia-insight-text">
                  {comparianceScore >= 90
                    ? "Excellent ITC management! "
                    : comparianceScore >= 80
                      ? "Good ITC practices. "
                      : comparianceScore >= 70
                        ? "Room for improvement in ITC optimization. "
                        : "Consider reviewing your ITC strategy. "}
                  Ensure proper documentation for all ITC claims and regular reconciliation with
                  GSTR-2A.
                </div>
              </div>
            </div>
