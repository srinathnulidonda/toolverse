      ...
      <div className="gr-root">
        ...
        <div className="gr-helper">
          <div className="gr-helper-content">
            ...
            <span>
              Reconcile your books with GST returns to identify mismatches and ensure compliance.
              Upload CSV/Excel files or enter amounts manually.
            </span>
          </div>
        </div>
        ...
        <div className="gr-upload-section">
          <div className="gr-upload-header">
            ...
            <p className="gr-upload-desc">
              Upload your books data and GST return files for automatic reconciliation
            </p>
          </div>
                ...
                <div className="gr-files-list">
                  {uploadedFiles.map((file, idx) => (
                    <div key={idx} className="gr-file-item">
                      ...
                      <span className="gr-file-size">{(file.size / 1024).toFixed(1)} KB</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="gr-input-section">
                <div className="gr-input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSalesData((prev) => ({ ...prev, booksAmount: e.target.value }))
                    }
                ...
                <div className="gr-input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSalesData((prev) => ({ ...prev, gstr1Amount: e.target.value }))
                    }
                ...
                <div className="gr-input-help">
                  ...
                  <span>
                    Compare your book sales with what you reported in GSTR-1 to identify missing
                    invoices or reporting errors.
                  </span>
                </div>
              </div>
            )}
              ...
              <div className="gr-input-section">
                <div className="gr-input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPurchaseData((prev) => ({ ...prev, booksAmount: e.target.value }))
                    }
                ...
                <div className="gr-input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPurchaseData((prev) => ({ ...prev, gstr2aAmount: e.target.value }))
                    }
                ...
                <div className="gr-input-help">
                  <i className="ti ti-bulb" />
                  <span>
                    Match your purchase records with supplier filings (GSTR-2A) to ensure you can
                    claim valid ITC.
                  </span>
                </div>
              </div>
              ...
              <div className="gr-input-section">
                <div className="gr-input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setITCData((prev) => ({ ...prev, claimedAmount: e.target.value }))
                    }
                ...
                <div className="gr-input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setITCData((prev) => ({ ...prev, availableAmount: e.target.value }))
                    }
                ...
                <div className="gr-input-help">
                  <i className="ti ti-bulb" />
                  <span>
                    Verify that your ITC claims match the credits available from supplier filings.
                  </span>
                </div>
              </div>
            )}
                  ...
                  onClick={() => {
                    if (activeType === "sales") {
                      ...
                      setPurchaseData((prev) => ({
                        ...prev,
                        booksAmount: "1500000",
                        gstr2aAmount: "1485000",
                      }));
                    } else {
                      setITCData((prev) => ({
                        ...prev,
                        claimedAmount: "225000",
                        availableAmount: "218000",
                      }));
                    }
                  }}
                >
            ...
            {!reconciliationResult && (
              <div className="gr-empty">
                ...
                <p className="gr-empty-desc">
                  Enter amounts above or upload files to start reconciling your GST returns with
                  book records
                </p>
              </div>
            )}
                      ...
                      <div className="gr-breakdown-rows">
                        <div className="gr-breakdown-row">
                          ...
                          <span className="gr-breakdown-value">
                            {formatCurrency(reconciliationResult.details.sales.books)}
                          </span>
                        </div>
                        <div className="gr-breakdown-row">
                          <span className="gr-breakdown-label">GSTR-1 Amount</span>
                          <span className="gr-breakdown-value">
                            {formatCurrency(reconciliationResult.details.sales.gstr1)}
                          </span>
                        </div>
                        <div
                          className={`gr-breakdown-row gr-breakdown-row--${reconciliationResult.salesVariance === 0 ? "success" : "warning"}`}
                        >
                    ...
                    <div className="gr-breakdown-section">
                      ...
                      <div className="gr-breakdown-rows">
                        <div className="gr-breakdown-row">
                          <span className="gr-breakdown-label">Books Amount</span>
                          <span className="gr-breakdown-value">
                            {formatCurrency(reconciliationResult.details.purchases.books)}
                          </span>
                        </div>
                        <div className="gr-breakdown-row">
                          <span className="gr-breakdown-label">GSTR-2A Amount</span>
                          <span className="gr-breakdown-value">
                            {formatCurrency(reconciliationResult.details.purchases.gstr2a)}
                          </span>
                        </div>
                        <div
                          className={`gr-breakdown-row gr-breakdown-row--${reconciliationResult.purchaseVariance === 0 ? "success" : "error"}`}
                        >
                          <span className="gr-breakdown-label">
                            <strong>Variance</strong>
                          </span>
                    ...
                    <div className="gr-breakdown-section">
                      ...
                      <div className="gr-breakdown-rows">
                        <div className="gr-breakdown-row">
                          ...
                          <span className="gr-breakdown-value">
                            {formatCurrency(reconciliationResult.details.itc.claimed)}
                          </span>
                        </div>
                        <div className="gr-breakdown-row">
                          <span className="gr-breakdown-label">Available in GSTR-2A</span>
                          <span className="gr-breakdown-value">
                            {formatCurrency(reconciliationResult.details.itc.available)}
                          </span>
                        </div>
                        <div
                          className={`gr-breakdown-row gr-breakdown-row--${reconciliationResult.itcVariance === 0 ? "success" : "error"}`}
                        >
                          <span className="gr-breakdown-label">
                            <strong>Variance</strong>
                          </span>
                  ...
                  <div className="gr-recommendations">
                    ...
                    <div className="gr-recommendations-list">
                      {reconciliationResult.recommendations.map((rec, idx) => (
                        <div
                          key={idx}
                          className={`gr-recommendation gr-recommendation--${rec.severity}`}
                        >
        ...
        {showAnalysis && reconciliationResult && (
          <div className="gr-analysis-section">
            <ReconcileAnalysis result={reconciliationResult} period={salesData.period} />
          </div>
        )}
        ...
        <div className="gr-footer">
          ...
          {reconciliationResult && (
            <div className="gr-footer-right">
              ...
              <span>
                Variances:{" "}
                {Math.abs(reconciliationResult.salesVariance) +
                  Math.abs(reconciliationResult.purchaseVariance) +
                  Math.abs(reconciliationResult.itcVariance) ===
                0
                  ? "None"
                  : "Found"}
              </span>
