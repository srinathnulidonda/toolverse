// features/image/image-compress/ProcessingStage.tsx
"use client";
    ...
    return (
        <div className={styles.processContainer} role="status" aria-live="polite">
            <div className={styles.spinnerWrap}>
                ...
                <i className={`ti ti-photo-edit ${styles.spinnerIcon}`} aria-hidden="true" />
            </div>

            <div className={styles.stageInfo}>
                <h3 className={styles.stageTitle}>Compressing your images</h3>
