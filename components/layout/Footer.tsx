    ...
    <footer className="footer">
      <div className="page-container">
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            <Link href="/" className="footer-logo" aria-label="Toolverse home">
              <img src="/logo.png" alt="Toolverse" className="footer-logo-image" />
            </Link>

            <p className="footer-description">
              51 privacy-first tools that run entirely in your browser. No uploads, no accounts, no
              limits.
            </p>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">© 2025 Toolverse. Built with privacy in mind.</p>
        </div>
      </div>
    </footer>
  );
