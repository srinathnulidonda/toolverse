...
export const TOOLS: Tool[] = [
    ...
    },
    {
        ...
        description: "Create professional GST-compliant invoices with multiple items, customer details, and templates.",
        category: "finance",
    ...
    },
    {
        ...
        description: "Calculate Input Tax Credit eligibility, blocked credits, and ITC utilization for GST compliance.",
        category: "finance",
        icon: "ti-coins",
    ...
    },
    {
        ...
        description: "Reconcile sales and purchase records with GST returns to identify mismatches and ensure compliance.",
        category: "finance",
        icon: "ti-git-compare",
