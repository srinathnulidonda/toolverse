...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: "Calculate late fees and interest for delayed GST return filing.",
    category: "finance",
    icon: "ti-alarm",
    href: "/tools/gst-late-fee-calculator",
    tags: ["gst", "late fee", "interest", "penalty", "filing"],
  },
  {
    slug: "emi-calculator",
  ...
  },
  {
    ...
    description: "Estimate how much loan you can afford based on income and existing obligations.",
    category: "finance",
    icon: "ti-building-bank",
    href: "/tools/loan-eligibility-calculator",
    tags: ["loan", "eligibility", "affordability", "emi"],
  },
  {
    slug: "sip-calculator",
  ...
  },
  {
    ...
    description: "Estimate the retirement corpus you'll need and the monthly investment to reach it.",
    category: "finance",
    icon: "ti-beach",
    href: "/tools/retirement-calculator",
    tags: ["retirement", "corpus", "investment", "planning"],
  },
  {
  ...
  },
  {
    ...
    description: "Calculate asset depreciation using Straight Line or Written Down Value methods.",
    category: "finance",
    icon: "ti-trending-down",
    href: "/tools/depreciation-calculator",
    tags: ["depreciation", "asset", "slm", "wdv", "accounting"],
  },
  {
    slug: "break-even-calculator",
    label: "Break-Even Calculator",
    description: "Find the sales volume where revenue covers costs and profit begins.",
    category: "finance",
    icon: "ti-target-arrow",
    href: "/tools/break-even-calculator",
    tags: ["break-even", "cost", "profit", "business"],
  },
  {
    slug: "net-worth-tracker",
    label: "Net Worth Tracker",
    description: "Track your assets and liabilities to calculate your net worth over time.",
    category: "finance",
    icon: "ti-scale",
    href: "/tools/net-worth-tracker",
    tags: ["net worth", "assets", "liabilities", "tracker"],
  },
