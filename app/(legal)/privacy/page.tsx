                ...
                <div className={styles.privacyHeroContainer}>
                    <div className={styles.privacyHeroContent}>
                        ...
                        <p className={styles.privacyHeroDescription}>
                            Your privacy is our priority. All processing happens locally in
                            your browser—we never see your files.
                        </p>
                    </div>
                </div>
            </section>
                            ...
                            <nav className={styles.privacyTocNav}>
                                {sections.map((section) => (
                                    <a
                                        ...
                                        className={`${styles.privacyTocLink} ${activeSection === section.id ? styles.active : ""
                                            }`}
                                    >
